...
{
    protected List<Vector3> ObjectVertices = new List<Vector3>();       //Global vertex points on the object mesh
    protected List<Vector3> ObjectUniqueVertices = new List<Vector3>(); //Global distinct vertex points on the object mesh
    protected List<Vector3> ObjectLocalVertices= new List<Vector3>();  //Local vertex points on the object mesh
    protected List<Vector3> CornerPoints= new List<Vector3>();
    protected List<Vector3> EdgeVectors= new List<Vector3>();
    ...
    private void CalculateObjectVertices() //local, global and unique global vertices calculated for the object
    {
        ...
        ObjectLocalVertices = new List<Vector3>(transform.gameObject.GetComponent<MeshFilter>().sharedMesh.vertices); //get vertice points with local coordinates from the mesh of the object
